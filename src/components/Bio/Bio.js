...
const Bio = () => (
  <p className={styles['author__subtitle']}>
      Father, Husband, Geek, Full Stack Developer, Team Lead. Currently working on making it easier to show real estate for rent at <a href="https://showdigs.com" target="_blank">Showdigs</a>
      <br/>
      <br/>
